...
"""
Section to choose how many games to look at.  Default code is for all cta joy games.
"""

# games_option = st.selectbox('Look back how many games?',
#     ["All", 500, 250, 100])

# if games_option == "All":
#     avg_player_stats = pd.read_csv(r"C:\Users\Clint\Documents\ARC\my_development\cta_dive\04 misc\streamlit\avg_player_stats_all.csv")
# elif games_option == "500":
#     avg_player_stats = pd.read_csv(r"C:\Users\Clint\Documents\ARC\my_development\cta_dive\04 misc\streamlit\avg_player_stats_500.csv")
# elif games_option == "250":
#     avg_player_stats = pd.read_csv(r"C:\Users\Clint\Documents\ARC\my_development\cta_dive\04 misc\streamlit\avg_player_stats_250.csv")
# else:
#     avg_player_stats = pd.read_csv(r"C:\Users\Clint\Documents\ARC\my_development\cta_dive\04 misc\streamlit\avg_player_stats_100.csv")
